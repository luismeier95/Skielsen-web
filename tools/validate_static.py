...
if '../assets/css/app.css' in dna_html or '../assets/css/tournament-theme-runtime.css' in dna_html: fail('Globale App-Styles duerfen DNA Standalone nicht laden')
...
if 'DNA_PAGE_SCROLL_SCOPE_V1' not in dna_css: fail('DNA Standalone Scroll-Scope Contract Marker fehlt')
if 'DNA_SCROLL_SCOPE_V2' not in dna_css: fail('DNA Standalone explicit html/body scroll scope fehlt')
...
if 'DNA_MOTION_SCALE_30625_V1' not in dna_css: fail('DNA Current Motion Scale Contract Marker fehlt')
if 'DNA_MERGE_CHOREOGRAPHY_V3' not in dna_css: fail('DNA Merge Choreography Marker fehlt')
if 'DNA_SCORE_COLLISION_GUARD_V1' not in dna_css: fail('DNA Score Collision Guard Marker fehlt')
if 'DNA_SWAP_TRANSFORM_UNBLOCK_V1' not in dna_css: fail('DNA Swap Transform Unblock Marker fehlt')
...
if 'DNA_INPUT_BASELINE_FIX_V1' not in dna_css: fail('DNA Input Baseline Contract Marker fehlt')
