...
if 'body.v15-inapp-fullscreen-open .mobile-nav' not in main_css: fail('Fullscreen blendet native App-Navigation nicht aus')
if 'transform:translateZ(0)' not in main_css or 'contain:paint' not in main_css: fail('In-App Compositor-Schutz fehlt')
