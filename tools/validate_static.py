...
if "if(dy<0)setMobileCollapsed(true)" not in admin_command_text or "else setMobileCollapsed(false)" not in admin_command_text: fail('Mobile Admin Command Swipe-Richtung ist nicht definiert')
...
if 'V15.1.91 · Mobile Admin Command responsive scroll collapse' not in main_css_text: fail('Mobile Admin Command Layout V15.1.90 fehlt')
