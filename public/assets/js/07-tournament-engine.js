...
function jokerTeamColorHex(p){
 return ({BLUE:'#2979FF',RED:'#FF1744',YELLOW:'#FF2ED1',GREEN:'#00F5D4'}[p?.color]||'var(--theme-accent)');
}
...
function updateTheme(){
 ...
 const player=userParticipant();if(player)document.documentElement.style.setProperty('--player',({BLUE:'#2979FF',RED:'#FF1744',YELLOW:'#FF2ED1',GREEN:'#00F5D4'}[player.color]||'var(--theme-accent)'))
}
